...
```
The functions bisect and hnewton are described further in software manual entries which can be found at the link: https: //github.com/tashajeske/Numerical-Analysis/blob/master/Software%20Manual/Table%20of%20Contents.md
